...
const UI_MODE_COOKIE = "fiado_ui_mode";
 ...
 * `fiado_ui_mode` (o servidor só renderiza este componente quando o cookie
...
export function ModoChooser() {
  // useSyncExternalStore (padrão do ComprovanteShell): no servidor é false,
  // então o overlay nunca entra no HTML — só aparece em viewport mobile.
    ...
    >
      <div className="mx-auto flex min-h-full w-full max-w-md flex-col justify-center gap-6 px-6 py-10">
        <header className="flex flex-col gap-2">
          ...
          >
            Como você prefere usar o FiadoApp no celular?
          </h1>
