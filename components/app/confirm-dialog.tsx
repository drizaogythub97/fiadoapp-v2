...
export function ConfirmDialog({
  ...
  // para ações destrutivas). Depende só de `open`: se este efeito rodasse a
  // cada re-render (ex.: por `onClose`/`pending`), digitar num campo do
  // diálogo devolveria o foco ao Cancelar a cada tecla.
  useEffect(() => {
    if (!open) return;
    const id = setTimeout(() => {
      panelRef.current
