...
const COOKIE = "fiado_ecossistema_anuncio";
...
/**
 * Anúncio ÚNICO e dispensável do ecossistema no Painel (F6, descoberta).
    ...
    >
      ...
      <div className="flex min-w-0 flex-col gap-1 pr-8">
        <p className="minimal:max-sm:text-sm text-base font-semibold">
          Conheça o Gaveta, o app de caixa da mesma família
        </p>
        <p className="minimal:max-sm:text-xs text-muted-foreground text-sm">
          Caixa, produtos e estoque com a mesma conta do FiadoApp.{" "}
          <Link
            href="/ecossistema"
